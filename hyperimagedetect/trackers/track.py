...
from hyperimagedetect.utils import YAML, IterableSimpleNamespace
from hyperimagedetect.utils.checks import check_yaml
...
def on_predict_start(predictor: object, persist: bool = False) -> None:
    ...
    if cfg.tracker_type == "botsort" and cfg.with_reid and cfg.model == "auto":
        from hyperimagedetect.nn.modules.head import Detect
