...
from hyperimagedetect.utils.metrics import OKS_SIGMA
from hyperimagedetect.utils.ops import crop_mask, xywh2xyxy, xyxy2xywh
from hyperimagedetect.utils.tal import RotatedTaskAlignedAssigner, TaskAlignedAssigner, dist2bbox, dist2rbox, make_anchors
    ...
    def __call__(self, preds: Any, batch: dict[str, torch.Tensor]) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        try:
            ...
            raise TypeError(
                ...
                "i.e. 'holo train model=holo11n-seg.pt data=coco8.yaml'.\nVerify your dataset is a "
                "correctly formatted 'segment' dataset using 'data=coco8-seg.yaml' "
                "as an example.\nSee https://docs.hyperimagedetect.com/datasets/segment/ for help."
            ) from e
    ...
    def __call__(self, preds: Any, batch: dict[str, torch.Tensor]) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        try:
            ...
            raise TypeError(
                ...
                "i.e. 'holo train model=holo11n-obb.pt data=coco8.yaml'.\nVerify your dataset is a "
                "correctly formatted 'OBB' dataset using 'data=dota8.yaml' "
                "as an example.\nSee https://docs.hyperimagedetect.com/datasets/obb/ for help."
            ) from e
