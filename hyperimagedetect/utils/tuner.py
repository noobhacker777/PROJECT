...
from hyperimagedetect.cfg import TASK2DATA, TASK2METRIC, get_cfg, get_save_dir
from hyperimagedetect.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, LOGGER, NUM_THREADS, checks, colorstr
...
def run_ray_tune(
    ...
    **train_args,
    ...
    tuner_callbacks = [WandbLoggerCallback(project="-tune")] if wandb else []
