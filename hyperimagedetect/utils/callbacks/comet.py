...
from hyperimagedetect.utils import LOGGER, RANK, SETTINGS, TESTS_RUNNING, ops
from hyperimagedetect.utils.metrics import ClassifyMetrics, DetMetrics, OBBMetrics, PoseMetrics, SegmentMetrics
...
def _get_comet_model_name() -> str:
    return os.getenv("COMET_MODEL_NAME", "HyperImageDetect")
...
def _resume_or_create_experiment(args: SimpleNamespace) -> None:
    ...
    try:
        ...
        experiment.log_other("Created from", "hyperimagedetect")
...
def on_fit_epoch_end(trainer) -> None:
    ...
    if curr_epoch == 1:
        from hyperimagedetect.utils.torch_utils import model_info_for_loggers
