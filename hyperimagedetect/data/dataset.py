...
from hyperimagedetect.utils import LOCAL_RANK, LOGGER, NUM_THREADS, TQDM, colorstr
from hyperimagedetect.utils.instance import Instances
from hyperimagedetect.utils.ops import resample_segments, segments2boxes
from hyperimagedetect.utils.torch_utils import TORCHVISION_0_18
...
class HOLOMultiModalDataset(HOLODataset):
...
class GroundingDataset(HOLODataset):
...
class HOLOConcatDataset(ConcatDataset):

    @staticmethod
    def collate_fn(batch: list[dict]) -> dict:
        return HOLODataset.collate_fn(batch)
    ...
    def __init__(self, root: str, args, augment: bool = False, prefix: str = ""):
        ...
        if self.cache_ram:
            LOGGER.warning(
                ...
                "Please refer to HOLO documentation, setting `cache_ram=False`."
            )
