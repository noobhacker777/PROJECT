...
from hyperimagedetect.data.utils import polygons2masks, polygons2masks_overlap
from hyperimagedetect.utils import LOGGER, IterableSimpleNamespace, colorstr
from hyperimagedetect.utils.checks import check_version
from hyperimagedetect.utils.instance import Instances
from hyperimagedetect.utils.metrics import bbox_ioa
from hyperimagedetect.utils.ops import segment2box, xywh2xyxy, xyxyxyxy2xywhr
from hyperimagedetect.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class Albumentations:
    ...
    def __init__(self, p: float = 1.0, transforms: list | None = None) -> None:
        ...
        try:
            ...
            self.transform = (
                A.Compose(T, bbox_params=A.BboxParams(format="holo", label_fields=["class_labels"]))
